...
<template>
  ...
  <div class="sgm-relative">
    <button
      class="sgm-z-20 sgm-absolute sgm-border-0 sgm-border-gray-400 sgm-drop-shadow-2xl -sgm-right-4 sgm-top-4 sgm-rounded-full sgm-bg-white sgm-p-1 sgm-text-black hover:sgm-bg-gray-50 focus-visible:sgm-outline focus-visible:sgm-outline-2 focus-visible:sgm-outline-offset-2 focus-visible:sgm-outline-black"
      v-if="canScrollRight"
      @click="scrollToRight"
    >
      <svg
    ...
    <button
      class="sgm-z-20 sgm-absolute sgm-border-0 sgm-border-gray-400 sgm-drop-shadow-xl -sgm-left-4 sgm-top-4 sgm-rounded-full sgm-bg-white sgm-p-1 sgm-text-black hover:sgm-bg-gray-50 focus-visible:sgm-outline focus-visible:sgm-outline-2 focus-visible:sgm-outline-offset-2 focus-visible:sgm-outline-black"
      v-if="canScrollLeft"
      @click="scrollToLeft"
    >
      <svg
