...
<template>
  ...
  >
    ...
    >
      <div
        class="sgm-text-zinc-500 sgm-text-lg sgm-tracking-wide sgm-font-light sgm-font-sm"
      >
        {{ searchFieldText }}
      </div>
      <div class="sgm-flex sgm-flex-row sgm-items-center sgm-space-x-2">
        <div
          class="sgm-px-2 sgm-py-1 sgm-flex sgm-flex-row sgm-items-center sgm-text-zinc-400 sgm-space-x-3 sgm-text-xs"
        >
          <svg
            width="24px"
            height="24px"
    ...
    <TransitionRoot appear :show="isOpen" as="div">
      <Dialog as="div" @close="closeModal" class="sgm-relative sgm-z-100">
        <TransitionChild
          as="template"
        ...
        >
          <div
            class="sgm-fixed sgm-inset-0 sgm-bg-transparent sgm-backdrop-filter sgm-backdrop-blur"
          />
        </TransitionChild>

        <div class="sgm-fixed sgm-inset-x-0 sgm-top-5 sgm-overflow-y-auto">
          <div
            class="sgm-flex md:sgm-min-h-full sgm-items-center sgm-justify-center sgm-pt-4 sgm-bg-white sgm-text-center"
          >
            <TransitionChild
              as="template"
              enter="sgm-duration-300 sgm-ease-out"
            ...
            >
              <DialogPanel
                class="sgm-w-full sgm-transform sgm-overflow-hidden sgm-transition-all sgm-border-b sgm-border-zinc-200"
              >
                <div class="">
                  <SigmieSearch
                    :facets="`categories:${numberOfCategories} price_as_number`"
                    :debounceMs="250"
                    :apiKey="props.apiKey"
                    :sort="sortBy"
                    :query="query"
                    ...
                    <Combobox @update:modelValue="visit" v-slot="{ open }">
                      ...
                      >
                        <div
                          ...
                          class="sgm-relative sgm-w-full sgm-cursor-default sgm-text-left sgm-outline-none sgm-focus:outline-none sm:sgm-text-sm"
                        >
                          ...
                          <div
                            class="sgm-w-full sgm-flex sgm-items-center sgm-justify-between sgm-px-10"
                          >
                            <a
                            ...
                            <div
                              class="sgm-max-w-3xl sgm-mx-auto sgm-py-4 sgm-flex sgm-flex-row sgm-items-center"
                            >
                              ...
                              <ComboboxInput
                                ...
                                class="sgm-ring-0 sgm-h-10 sgm-mx-auto sgm-p-2 sgm-w-full sgm-outline-none sgm-border-none sgm-focus:outline-none sgm-px-12 sgm-text-base sgm-leading-3 sgm-text-zinc-400"
                                :displayValue="() => query"
                          ...
                          <div v-else class="sgm-flex sgm-flex-row sgm-pt-10">
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <div
                                    class="sgm-flex sgm-flex-row sgm-justify-between sgm-items-center sgm-px-10 sgm-h-10 sgm-cursor-pointer"
                                    :class="
                                      active || selected
                                        ? 'sgm-bg-zinc-100'
                                        : ''
                            ...
                            >
                              ...
                              <ComboboxOptions
                                v-else
                                :class="{
                                  'sgm-grid-cols-1 sm:sgm-grid-cols-3 lg:sgm-grid-cols-6':
                                    !showCategories,
                                  'sgm-grid-cols-1 sm:sgm-grid-cols-2 lg:sgm-grid-cols-4':
                                    showCategories,
                                }"
                                class="sgm-mt-6 sgm-grid sgm-gap-x-6 sgm-gap-y-10 xl:sgm-gap-x-8"
                              >
                                <ComboboxOption
