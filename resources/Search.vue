        ...
        <TransitionRoot appear :show="isOpen" as="template">
            <Dialog as="div" @close="closeModal" class="sgm-relative sgm-z-50">
                ...
                <div class="sgm-fixed sgm-inset-x-0 sgm-top-5 sgm-overflow-y-auto">
                    <div class="sgm-flex md:sgm-min-h-full sgm-items-center sgm-justify-center sgm-pt-4 sgm-bg-white sgm-text-center">
                                                    ...
                                                    <div v-else class="sgm-flex sgm-flex-row sgm-pt-10">
                                                        ...
                                                        <div :class="{
                                                            ...
                                                            <div v-if="loading && showLoader">
                                                                <svg aria-hidden="true" class="md:sgm-w-10 md:sgm-h-10 sgm-h-6 sgm-w-6 sgm-text-zinc-600 sgm-animate-spin sgm-fill-zinc-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <ComboboxOptions v-else :class="{
                                                                'sgm-grid-cols-1 sm:sgm-grid-cols-3 lg:sgm-grid-cols-6': !showCategories,
                                                                'sgm-grid-cols-1 sm:sgm-grid-cols-2 lg:sgm-grid-cols-4': showCategories,
