...
<template>
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        }" @click="openModal" class="fowcus:ring-0 mt-10 max-w-xl mx-auto flex flex-row justify-between text-zinc-900 w-full border backdrop-filter backdrop-blur bg-zinc-100/30 items-center px-2 py-1">
            <div class="text-zinc-500 text-lg tracking-wide font-light font-sm">
                {{ searchFieldText }}
            </div>
                                            ...
                                            <div :class="{
                                                ...
                                                <div :class="{
                                                    ...
                                                    <div class="w-full flex items-center justify-between px-10">
                                                        ...
                                                        <div class="max-w-3xl mx-auto py-4 flex flex-row items-center">
                                                            <!-- <svg class="h-4 w-4" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                <g stroke="currentColor" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                                                                    <g transform="translate(2.000000, 2.000000)" stroke="currentColor" stroke-width="1.5">
                                                                        <circle id="Ellipse_739" cx="9.76659044" cy="9.76659044" r="8.9885584"></circle>
                                                                        <line x1="16.0183067" y1="16.4851259" x2="19.5423342" y2="20.0000001" id="Line_181" opacity="0.400000006"></line>
                                                            ...
                                                            <ComboboxInput autocomplete="off" ref="input" :class="{
                                                                ...
                                                                '':
                                                                    open,
                                                            }" class="ring-0 h-10 mx-auto p-2 w-full outline-none border-none focus:outline-none px-12 text-md leading-3 text-zinc-400" :displayValue="() => query" @change="
    query =
    $event.target
        .value
    ">
                                                ...
                                                <TransitionRoot leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0" @after-leave="query = ''">
                                                    ...
                                                    <div class="mx-auto max-w-7xl w-full flex flex-col items-center h-56" v-if="total === 0 && !loading">
                                                    ...
                                                    <div v-else class="flex flex-row pt-10">
                                                        <div v-if="showCategories" :class="{
                                                            'w-1/3': showCategories
                                                        }" class="flex flex-col  max-h-[800px] overflow-y-scroll">
                                                        ...
                                                        <div :class="{
                                                            'w-2/3': showCategories,
                                                            'w-full': !showCategories
                                                        }" class="h-full pb-20 px-12 max-h-[800px] overflow-y-scroll">
                                                            ...
                                                            <ComboboxOptions v-else :class="{
                                                                'grid-cols-1 sm:grid-cols-3 lg:grid-cols-6': !showCategories,
                                                                'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4': showCategories,
                                                            }" class="mt-6 grid  gap-x-6 gap-y-10 xl:gap-x-8">
